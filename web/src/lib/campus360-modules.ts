...
export const roleDefinitions: RoleDefinition[] = [
  ...
  },
  {
    ...
    access: "Linked student view",
    responsibility: "Views linked student attendance, fees, homework, results, transport, hostel, and notices.",
  },
];
...
export const campus360Modules: Campus360Module[] = [
  ...
  {
    id: "parent-guardian-portal",
    number: 3,
    title: "Parent / Guardian Portal",
    area: "People",
    status: "live",
    summary: "Family access to linked student progress, fees, attendance, transport, hostel, and notices.",
    owner: "Student services team",
    responsibility: "Keep parent access connected to verified student guardian links and campus communication.",
    features: [
    ...
    components: ["Guardian links", "Family dashboard", "Fee view", "Student updates", "Announcements"],
